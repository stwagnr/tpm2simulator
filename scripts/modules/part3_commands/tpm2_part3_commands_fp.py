...
class CommandsPrototypeFile:
    """
    """

    def __init__(self):
        self.file_path = constants.SRC_PATH + constants.TPM_PATH + "include/prototypes/Commands_fp.h"
        self.header_name = "_COMMANDS_FP_H_"

        self.content = u''    # the content of the file
        self.file = None      # the output file handle

    # Appends string to commands prototype file contents
    # Parameter:
    # content
    def append(self, content):
        self.content += content

    # Writes contents into commands prototype file
    def write(self):
